...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/b22f422728f35127e5596c4b58ce193a100cc5ba/src/core/game/GameImpl.ts
// Modified for this vendor build (auto-trimmed by scripts/vendor-engine.mjs) -
// dropped the `UnitView` union arm(s) and the now-unused client/view import; repointed the renderNumber/renderTroops import at the local, non-upstream RenderNumber.ts extract instead of client/Utils.ts.
