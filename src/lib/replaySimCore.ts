...
export const KNOWN_ENGINE_COMMITS = [
  ...
  '577819ba0e1e13ecdbc8dede2ba33de542c88a67',
  '1e973bb534b8b37d8d30c80ab27ad1391a7b82da',
  'a33efb780c4daf7cfb703bb3e8c7ce5d3f014325',
  '8ab4aa2f57859a596acc0daeb5b26524c564e997',
  '222e4078982e6c21c620a69c82de0392c17385bf',
  '129cfcb1c3e7986de1a8007a024905bbadb36526',
  'ece79bfd33483c139469faa0553154e3a229e069',
  '27611ec0b209b1b758b99617a297ee8b37ef7a03',
  'fb07e61a9161b3b8e0991c6dc0e0ef6406f653e3',
  '2be7dfe239ea26d01f566910fb6f50b059c89e8a',
  '82e5fce9502b99516b5b4b8f06fc0b88823a0cbc',
  '7c27263390d8f1976566e5c5ad9adf6fcad311b6',
  'cfa6c47a1a58cdc5f9a779980c2896d92dcb8f8c',
  'a76a11b837e80b6209bc234f9c3b20c5f4c0c738',
...
async function loadCreateGameRunner(commit: EngineCommit) {
  switch (commit) {
    ...
    case '577819ba0e1e13ecdbc8dede2ba33de542c88a67':
      return (await import('../vendor/openfront-core-577819b/src/core/GameRunner')).createGameRunner
    case '1e973bb534b8b37d8d30c80ab27ad1391a7b82da':
      return (await import('../vendor/openfront-core-1e973bb/src/core/GameRunner')).createGameRunner
    case 'a33efb780c4daf7cfb703bb3e8c7ce5d3f014325':
      return (await import('../vendor/openfront-core-a33efb7/src/core/GameRunner')).createGameRunner
    case '8ab4aa2f57859a596acc0daeb5b26524c564e997':
      return (await import('../vendor/openfront-core-8ab4aa2/src/core/GameRunner')).createGameRunner
    case '222e4078982e6c21c620a69c82de0392c17385bf':
      return (await import('../vendor/openfront-core-222e407/src/core/GameRunner')).createGameRunner
    case '129cfcb1c3e7986de1a8007a024905bbadb36526':
      return (await import('../vendor/openfront-core-129cfcb/src/core/GameRunner')).createGameRunner
    case 'ece79bfd33483c139469faa0553154e3a229e069':
      return (await import('../vendor/openfront-core-ece79bf/src/core/GameRunner')).createGameRunner
    case '27611ec0b209b1b758b99617a297ee8b37ef7a03':
      return (await import('../vendor/openfront-core-27611ec/src/core/GameRunner')).createGameRunner
    case 'fb07e61a9161b3b8e0991c6dc0e0ef6406f653e3':
      return (await import('../vendor/openfront-core-fb07e61/src/core/GameRunner')).createGameRunner
    case '2be7dfe239ea26d01f566910fb6f50b059c89e8a':
      return (await import('../vendor/openfront-core-2be7dfe/src/core/GameRunner')).createGameRunner
    case '82e5fce9502b99516b5b4b8f06fc0b88823a0cbc':
      return (await import('../vendor/openfront-core-82e5fce/src/core/GameRunner')).createGameRunner
    case '7c27263390d8f1976566e5c5ad9adf6fcad311b6':
      return (await import('../vendor/openfront-core-7c27263/src/core/GameRunner')).createGameRunner
    case 'cfa6c47a1a58cdc5f9a779980c2896d92dcb8f8c':
      return (await import('../vendor/openfront-core-cfa6c47/src/core/GameRunner')).createGameRunner
    case 'a76a11b837e80b6209bc234f9c3b20c5f4c0c738':
      return (await import('../vendor/openfront-core-a76a11b/src/core/GameRunner')).createGameRunner
    case '59da4bc1bfaacaad02d782b988fd3e228037aff7':
      return (await import('../vendor/openfront-core-59da4bc/src/core/GameRunner')).createGameRunner
    case '824d1412be580da8a1309010d00f984483ad2c31':
