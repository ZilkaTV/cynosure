...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/16be9d7c15d7abc115691def3a0b2aa559664705/src/core/execution/TradeShipExecution.ts
// Modified for this vendor build - see src/vendor/openfront-core-16be9d7/README.md
// for exactly what changed and why (repointed the `renderNumber` import at the local, non-upstream RenderNumber.ts extract instead of client/Utils.ts).
