...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/0cb90ccb74787e8384f030517423826fe9f607a9/src/core/Schemas.ts
// Modified for this vendor build (auto-trimmed by scripts/vendor-engine.mjs) -
// repointed the resources/QuickChat.json path-alias import at the vendored copy with a relative import.
// Also repointed ../../zbin (upstream's repo-root zbin/ package, outside src/) at
// ../zbin, a copy of that package moved under src/ so it stays within tsconfig's rootDir.
