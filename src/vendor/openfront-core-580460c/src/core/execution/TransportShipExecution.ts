...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/580460c9692aea2bdc1dce97eba1bbee378e270d/src/core/execution/TransportShipExecution.ts
// Modified for this vendor build (auto-trimmed by scripts/vendor-engine.mjs) -
// repointed the renderNumber/renderTroops import at the local, non-upstream RenderNumber.ts extract instead of client/Utils.ts.
