...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/e9e10703e8188f2a34defdeda9598778a934094a/src/core/utilities/RenderNumber.ts
...
// only) at commit e9e10703e8188f2a34defdeda9598778a934094a - this commit's body differs from the shared
// canonical extract (src/vendor/openfront-core/.../RenderNumber.ts), so this
// tree gets its OWN copy instead of reusing that one.
// Licensed AGPL-3.0-or-later - see openfront-core-e9e1070/README.md.
