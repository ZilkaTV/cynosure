...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/aeb8d60224e3eb72fdbae0fdf91ebb8a9affe77d/src/core/configuration/DefaultConfig.ts
...
import { Config, GameEnv, NukeMagnitude, ServerConfig } from "./Config";
import { Env } from "./Env";
...
export class DefaultConfig implements Config {
  ...
  // theme() dropped along with the Theme interface - see Config.ts.
