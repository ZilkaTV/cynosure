...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/88cc95d8b6d74d951546da341be809bfb3cab960/src/core/utilities/RenderNumber.ts
...
// only) at commit 88cc95d8b6d74d951546da341be809bfb3cab960 - this commit's body differs from the shared
// canonical extract (src/vendor/openfront-core/.../RenderNumber.ts), so this
// tree gets its OWN copy instead of reusing that one.
// Licensed AGPL-3.0-or-later - see openfront-core-88cc95d/README.md.
