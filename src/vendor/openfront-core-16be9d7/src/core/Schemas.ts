...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/16be9d7c15d7abc115691def3a0b2aa559664705/src/core/Schemas.ts
// Modified for this vendor build - see src/vendor/openfront-core-16be9d7/README.md
// for exactly what changed and why (the `resources/QuickChat.json` import relies on a path alias this vendor build doesn't replicate - pointed at the vendored copy in src/vendor/openfront-core-16be9d7/resources with a relative import instead; content unchanged).
