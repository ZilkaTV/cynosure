...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/59da4bc1bfaacaad02d782b988fd3e228037aff7/src/core/utilities/RenderNumber.ts
...
// only) at commit 59da4bc1bfaacaad02d782b988fd3e228037aff7 - this commit's body differs from the shared
// canonical extract (src/vendor/openfront-core/.../RenderNumber.ts), so this
// tree gets its OWN copy instead of reusing that one.
// Licensed AGPL-3.0-or-later - see openfront-core-59da4bc/README.md.
