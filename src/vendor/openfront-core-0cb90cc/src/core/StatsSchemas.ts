...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/0cb90ccb74787e8384f030517423826fe9f607a9/src/core/StatsSchemas.ts
// Modified for this vendor build (manual fix, not automated by scripts/vendor-engine.mjs) -
// repointed ../../zbin (upstream's repo-root zbin/ package, outside src/) at ../zbin,
// a copy of that package moved under src/ so it stays within tsconfig's rootDir.
import { z } from "zod";
