...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/fe5d7708e03ac08c1a62c2eb694e58d564f86ab4/src/core/game/UnitGrid.ts
// Modified for this vendor build (auto-trimmed by scripts/vendor-engine.mjs) -
// dropped the `UnitView` union arm(s) and the now-unused client/view import.
