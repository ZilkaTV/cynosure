...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/53e1a5b03e35c27a3130c1c534f9416b8d6c724f/src/core/configuration/Config.ts
// Modified for this vendor build (auto-trimmed by scripts/vendor-engine.mjs) -
// dropped the `PlayerView` union arm(s) and the now-unused client/view import.
import { z } from "zod";
