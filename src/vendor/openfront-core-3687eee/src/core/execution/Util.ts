...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/3687eee03bec116b7d19f470bffdd62648180372/src/core/execution/Util.ts
// Modified for this vendor build (auto-trimmed by scripts/vendor-engine.mjs) -
// dropped the `GameView` union arm(s) and the now-unused client/view import.
