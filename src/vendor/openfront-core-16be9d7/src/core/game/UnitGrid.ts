...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/16be9d7c15d7abc115691def3a0b2aa559664705/src/core/game/UnitGrid.ts
// Modified for this vendor build - see src/vendor/openfront-core-16be9d7/README.md
// for exactly what changed and why (dropped the `Unit | UnitView` union arms and the now-unused `client/view` import).
