...
// Source: https://github.com/openfrontio/OpenFrontIO/blob/577819ba0e1e13ecdbc8dede2ba33de542c88a67/src/core/utilities/RenderNumber.ts
...
// only) at commit 577819ba0e1e13ecdbc8dede2ba33de542c88a67 - this commit's body differs from the shared
// canonical extract (src/vendor/openfront-core/.../RenderNumber.ts), so this
// tree gets its OWN copy instead of reusing that one.
// Licensed AGPL-3.0-or-later - see openfront-core-577819b/README.md.
